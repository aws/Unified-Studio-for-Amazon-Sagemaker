...
for ACCOUNT_ID in $ACCOUNT_IDS; do
    ...
    aws cloudformation deploy \
        --template-file templates/cloudformation/03-project-account/deploy/01-stackset-execution-role.yaml \
...
aws cloudformation create-stack-set \
    ...
    --template-body file://templates/cloudformation/01-org-mgmt-account/deploy/03-trust-policy-stackset.yaml \
