...
class TestS3BundleStorage:
    ...
    def test_download_bundle_s3(self, mock_mkstemp, mock_create_client):
        ...
        with patch('os.close') as mock_close:
            result_path = download_bundle("s3://test-bucket/bundles/TestPipeline.zip", "us-east-1")
    ...
    def test_find_bundle_file_s3(self, mock_create_client):
        ...
        result = find_bundle_file("s3://test-bucket/bundles", "TestPipeline", "us-east-1")
    ...
    def test_find_bundle_file_s3_fallback(self, mock_create_client):
        ...
        result = find_bundle_file("s3://test-bucket/bundles", "NonExistent", "us-east-1")
...
class TestS3BundleIntegration:
    ...
    def test_s3_bundle_workflow(self, datazone_s3_bucket):
        ...
        with patch('src.smus_cicd.helpers.bundle_storage.create_s3_client') as mock_create_client:
            mock_s3 = Mock()
            mock_create_client.return_value = mock_s3
            ...
            with tempfile.NamedTemporaryFile(suffix='.zip') as temp_file:
                ...
                assert args[1] == "sagemaker-unified-studio-<aws-account-id>-us-east-1-test-domain"  # bucket
