...
@patch("smus_cicd.commands.monitor.load_config")
@patch("smus_cicd.commands.monitor.get_datazone_project_info")
@patch("smus_cicd.pipeline.PipelineManifest.from_file")
def test_monitor_all_targets(mock_from_file, mock_get_project_info, mock_load_config, sample_manifest):
...
@patch("smus_cicd.commands.monitor.get_datazone_project_info")
@patch("smus_cicd.pipeline.PipelineManifest.from_file")
def test_monitor_single_target(mock_from_file, mock_get_project_info, mock_load_config, sample_manifest):
...
@patch("smus_cicd.commands.monitor.get_datazone_project_info")
@patch("smus_cicd.pipeline.PipelineManifest.from_file")
def test_monitor_inactive_project(mock_from_file, mock_get_project_info, mock_load_config, sample_manifest):
