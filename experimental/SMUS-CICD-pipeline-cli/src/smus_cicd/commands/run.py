...
def _resolve_targets(targets: Optional[str], manifest: PipelineManifest) -> Dict[str, Any]:
    """
...
def _validate_and_get_targets(target_list: List[str], manifest: PipelineManifest) -> Dict[str, Any]:
    """
...
def _get_workflow_connections(project_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        name: info for name, info in connections.items() 
