...
def _resolve_aws_resources(
    ...
    dev_project_name = "dev-project-name  # PLACEHOLDER: Replace with your dev project name"
...
def _handle_general_error(error: Exception, domain_id: str, dev_project_id: str) -> None:
...
def _determine_project_config(stage: str, dev_project_name: str) -> Tuple[str, bool]:
    ...
    if dev_project_name != "dev-project-name  # PLACEHOLDER: Replace with your dev project name":
...
def _display_next_steps(domain_id: Optional[str], dev_project_id: Optional[str]) -> None:
