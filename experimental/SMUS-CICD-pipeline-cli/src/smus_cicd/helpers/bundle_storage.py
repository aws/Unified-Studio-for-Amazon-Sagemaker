...
def upload_bundle(local_bundle_path: str, bundles_directory: str, pipeline_name: str, region: str = None) -> str:
...
def find_bundle_file(bundles_directory: str, pipeline_name: str, region: str = None) -> Optional[str]:
    ...
    if is_s3_url(bundles_directory):
        ...
        try:
            ...
            for obj in response['Contents']:
                ...
                if filename.endswith('.zip') and pipeline_name.lower() in filename.lower():
