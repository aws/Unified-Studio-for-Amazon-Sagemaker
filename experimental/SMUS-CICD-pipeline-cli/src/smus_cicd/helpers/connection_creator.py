...
class ConnectionCreator:
    ...
    def _get_custom_datazone_client(self):
        ...
        if self._custom_client is None:
            ...
            if not model_path.exists():
                raise FileNotFoundError(f"Custom DataZone model not found at {model_path}")
    ...
    def create_connection(
        ...
        **kwargs,
        ...
        client = self._get_custom_datazone_client() if connection_type == "MLFLOW" else self.client
    ...
    def update_connection(self, connection_id: str, name: str, connection_type: str, props: Dict[str, Any], environment_id: str) -> str:
        ...
        try:
            ...
            raise Exception(f"Failed to update {connection_type} connection '{name}': {str(e)}")
