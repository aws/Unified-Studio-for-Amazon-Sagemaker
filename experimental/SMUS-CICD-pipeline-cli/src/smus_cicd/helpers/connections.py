...
def extract_connection_properties(connection_detail: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if connection_type == 'S3':
        ...
        if not env_name and connection_detail.get('domain_id') and connection_detail.get('project_id'):
...
def get_project_connections(project_name: str, domain_name: str, region: str) -> Dict[str, Dict[str, Any]]:
