...
def validate_manifest_schema(manifest_data: Dict[str, Any], schema: Dict[str, Any] = None) -> Tuple[bool, List[str]]:
    """
...
def validate_manifest_file(manifest_path: str) -> Tuple[bool, List[str], Dict[str, Any]]:
    """
