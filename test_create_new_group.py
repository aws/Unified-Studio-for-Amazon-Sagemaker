...
# Test with GitHubActionsRole which should exist but might not have a group
TEST_ROLE_ARN = "arn:aws:iam::198737698272:role/TestRoleForGroupCreation"
DOMAIN_ID = "dzd-614fzsz5nulxm1"
REGION = "us-east-2"

print("Testing group creation for a role without existing group profile\n")
